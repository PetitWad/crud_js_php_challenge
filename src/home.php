		...
		<div id="secondSection" class="container-fluid pl-3">
			<div class="row">
				<div class="col-4">
					...
					<form id="insertProd" method="POST">
					...
					<table class="table table-sm table-bordered table-hover">
						...
						<?php foreach ($proddao->read() as $prod) : ?>
							<tr>
								...
								<td><?= $prod->getPrix() ?> <strong>HTG</strong></td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action="controller/UpdateProduct.php" method="POST">
												<label for="nomProduit">Nom du produit:</label>
												<input type="text" class="form-control" value="<?= $prod->getNomProduit() ?>" id="nomProduitUpd" name="nomProduit">
												<label for="prix">Prix:</label>
												<input type="text" class="form-control" value="<?= $prod->getPrix() ?>" id="prixUpd" name="prix">
												<label for="description">Description:</label>
												<textarea class="form-control" value="" id="descriptionUdp" name="description"><?= $prod->getDescription() ?></textarea>
