						...
						<div class="row">
							<div class="col-4">
								<form id="insertUser" method="POST">
									<div class="mb-2">
										<label>Nom</label>
										<input type="text" name="nom" autofocus class="form-control" required />
									</div>
									<div class="mb-2">
										<label>Prenom</label>
										...
										<tbody>
											<?php foreach ($userdao->read() as $users) : ?>
												<tr>
													...
													<td><?= $users->getSex() ?></td>
													<td class="pl-2">
														<a class="btn  btn-warning btn-sm" href="updateUser.php?delUser=<?= $users->getId() ?>"><i class="bi bi-pen-fill"></i></a>
					...
					<table class="table table-sm table-bordered table-hover">
						...
						<?php foreach ($proddao->read() as $prod) : ?>
							<tr>
								...
								<td class="pl-2">
									<a class="btn  btn-warning btn-sm" href="updateProduct.php?delProd=<?= $prod->getId() ?>"><i class="bi bi-pen-fill"></i></a>
